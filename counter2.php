...
<html lang="en">
    ...
    <head>
        ...
        <title>ACLC ACCOUNTING QUEUE Counter 2</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">CASHIER COUNTER 2</h1>
                                        </div>
                                         <form id="form1" name="form1" method="get" action="translogin2.php">
<!--                                            
